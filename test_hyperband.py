...
searcher = HyperbandSearch(GenerativeModel, param_ranges, L_train)
#searcher = RandomSearch(GenerativeModel, param_ranges, L_train)


gen_model, run_stats = searcher.fit(L_dev, L_gold_dev, n_threads=1)
